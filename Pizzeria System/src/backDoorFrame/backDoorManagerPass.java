...
public class backDoorManagerPass extends JFrame {
	private static int someOpen = 0;
	public backDoorManagerPass(int x,int y,int weight,int height){
		...
		submit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
     			...
     			if (passText.equals("205515828")){
     				dispose();
     				backdoorFrame backDoorFrame = new backdoorFrame();
     				someOpen = 0;
     			}
     			else
